...
| 8 | `promo_1400x560.png` | 1400x560 PNG | Marquee promo tile | Mark, wordmark and positioning line on brand background. Generated by `pnpm ui:store` | PASS |
...
- [x] Generate a 1400x560 marquee promo tile (2026-08-11, `promo_1400x560.png`).
